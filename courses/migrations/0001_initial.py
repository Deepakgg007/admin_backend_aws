    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="Introduction video URL (YouTube, Vimeo, etc.)",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="College that owns this course",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.IntegerField(
                        default=0, help_text="Display order within course"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource_file",
                    models.FileField(
                        blank=True, null=True, upload_to="task_resources/"
                    ),
                ),
                (
                    "reference_links",
                    models.JSONField(
                        blank=True, default=list, help_text="Array of reference URLs"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document",
                    models.FileField(
                        upload_to="task_documents/", verbose_name="Document File"
                    ),
                ),
                ("description", models.TextField(blank=True, null=True)),
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Display order within task",
                        verbose_name="Order",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "marks",
                    models.PositiveIntegerField(
                        default=1, help_text="Marks for this question"
                    ),
                ),
                (
                    "order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "choice_1_text",
                    models.CharField(max_length=500, verbose_name="Choice 1"),
                ),
                (
                    "choice_1_is_correct",
                    models.BooleanField(default=False, verbose_name="Choice 1 Correct"),
                ),
                (
                    "choice_2_text",
                    models.CharField(max_length=500, verbose_name="Choice 2"),
                ),
                (
                    "choice_2_is_correct",
                    models.BooleanField(default=False, verbose_name="Choice 2 Correct"),
                ),
                (
                    "choice_3_text",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="Choice 3"
                    ),
                ),
                (
                    "choice_3_is_correct",
                    models.BooleanField(default=False, verbose_name="Choice 3 Correct"),
                ),
                (
                    "choice_4_text",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="Choice 4"
                    ),
                ),
                (
                    "choice_4_is_correct",
                    models.BooleanField(default=False, verbose_name="Choice 4 Correct"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(help_text="URL-friendly title", max_length=255),
                ),
                (
                    "order",
                    models.PositiveIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional code block title",
                        max_length=255,
                        null=True,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Tracks completed content items: {content_type: [content_ids]}",
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "score_weight",
                    models.PositiveIntegerField(
                        default=1, help_text="Weight/points for this test case"
                    ),
                ),
                (
                    "order",
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        ...
                        max_length=500,
                        null=True,
                        validators=[courses.models.validate_youtube_url],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_preview",
                    models.BooleanField(
                        default=False, help_text="Available before enrollment"
                    ),
                ),
                ("is_published", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.PositiveIntegerField(
                        default=0, help_text="Order of topic in syllabus"
                    ),
                ),
                (
                    "syllabus",
        ...
        migrations.AddIndex(
            model_name="course",
            index=models.Index(
                fields=["status", "is_featured"], name="courses_status_9c57da_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="course",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["task", "order"], name="task_docume_task_id_37ae96_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskquestion",
            index=models.Index(
                fields=["task", "order"], name="task_questi_task_id_b94aac_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskquestion",
            index=models.Index(
                fields=["question_type"], name="task_questi_questio_2bf1cf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskrichtextpage",
            index=models.Index(
                fields=["task", "order"], name="task_richte_task_id_7c7549_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskrichtextpage",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["page", "order"], name="task_code_b_page_id_478633_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="tasksubmission",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["coding_question", "is_sample"],
                name="task_test_c_coding__14aa3d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="tasktextblock",
            index=models.Index(
                fields=["page", "order"], name="task_text_b_page_id_8f9dd7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskvideo",
            index=models.Index(
                fields=["task", "order"], name="task_videos_task_id_4c4f2f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskvideoblock",
            index=models.Index(
                fields=["page", "order"], name="task_video__page_id_cdc2d9_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="syllabustopic",
