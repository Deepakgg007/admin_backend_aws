    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "weight",
                    models.PositiveIntegerField(
                        default=1, help_text="Weight/points for this question"
                    ),
                ),
                (
                    "order",
                    models.PositiveIntegerField(
                        default=1, help_text="Display order in the certification"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_correct",
                    models.BooleanField(
                        default=False, help_text="Mark as correct answer"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="course_cert.certificationquestion",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "selected_options",
                    models.JSONField(help_text="List of selected option IDs"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="course_cert.certificationattempt",
                    ),
                ),
                (
                    "question",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["college", "is_active"], name="course_cert_college_a79311_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="certification",
            index=models.Index(
                fields=["course", "is_active"], name="course_cert_course__8f8dfc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="certificationattempt",
            index=models.Index(
                fields=["user", "certification"], name="course_cert_user_id_3beaa3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="certificationattempt",
            index=models.Index(
                fields=["completed_at"], name="course_cert_complet_22d228_idx"
            ),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("certification", "order"), name="unique_order_per_certification"
            ),
        ),
        migrations.AddConstraint(
